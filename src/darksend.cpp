...
{
    if(fLiteMode) return; // ignore all CephCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat CephCoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("cephcoin-privatesend");

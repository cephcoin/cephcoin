...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CephCoinNetwork") type = CephCoinNetwork;
    if(strType == "CephCoinNetworkVariable") type = CephCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CephCoinNetwork) s = "CephCoinNetwork";
    if(type == CephCoinNetworkVariable) s = "CephCoinNetworkVariable";

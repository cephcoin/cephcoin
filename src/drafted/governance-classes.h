 ...
 *
 *   // network
 *   CCephCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.cephcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCephCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CCephCoinNetwork(UniValue objIn)
    {
...
// // can be under: CephCoinNetwork
// //   -- signature requirements : Key1(User)
// class CCephCoinNetworkVariable : public CGovernanceObject
// {
// private:

    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CEPH-light"), QVariant("light"));
    ui->theme->addItem(QString("CEPH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CEPH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CEPH-traditional"), QVariant("trad"));

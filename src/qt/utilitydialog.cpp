    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("CephCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About CephCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  cephcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CephCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CEPH, 0.1 CEPH, 1 CEPH and 10 CEPH -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://cephcoincoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://cephcoincoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("CephCoin Core is shutting down...") + "<br /><br />" +

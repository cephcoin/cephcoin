    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("CephCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CephCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cephcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About CephCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CephCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CephCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CephCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CephCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a cephcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CephCoin Core help message to get a list with possible CephCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("CephCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CephCoin network", "", count));
}
...
{
    QString strTitle = tr("CephCoin Core"); // default title

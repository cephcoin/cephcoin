...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("CephCoin Core cephcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cephcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cephcoin transaction") + "\n" +
              "  cephcoin-tx [options] -create [commands]   " + _("Create hex-encoded cephcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cephcoin transaction

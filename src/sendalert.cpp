...
2. run cephcoind with -printalert or -sendalert like this:
   /path/to/cephcoind -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.cephcoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/CephCoin Core:0.12.0.58/"));

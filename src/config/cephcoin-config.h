/* src/config/cephcoin-config.h.  Generated from cephcoin-config.h.in by configure.  */
/* src/config/cephcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CEPHCOIN_CONFIG_H

#define CEPHCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/cephcoincoin/cephcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CephCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CephCoin Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cephcoincore"

...
CephCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as CephCoin Core, where everyone uses
...
pay attention to for reviewers of CephCoin Core code.

General CephCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: CephCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion

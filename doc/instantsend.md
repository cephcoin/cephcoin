...
This mechanism has been integrated into Bitcore-Node-CephCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cephcoincoin/insight-api-cephcoin#web-socket-api](https://github.com/cephcoincoin/insight-api-cephcoin#web-socket-api) 
* API: [https://github.com/cephcoincoin/insight-api-cephcoin#instantsend-transactions](https://github.com/cephcoincoin/insight-api-cephcoin#instantsend-transactions) 
...
By default, the CephCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CephCoin Core daemon:

...
Only requiring some minor changes is cephcoin.cpp.
...
Changes to cephcoin.cpp
----------------------
cephcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
